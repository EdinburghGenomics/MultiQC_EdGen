...
class MultiqcModule(BaseMultiqcModule):
    ...
    def __init__(self):
        ...
        # Not sure why I'm not using find_log_files for this?
        ...
        for n, f in enumerate(self.find_log_files('edgen_unassigned', filehandles=True)):
            ...
            html += '<p>The counts generated by bcl2fastq are approximate.</p>\n'
        ...
        if not (legacy_reports or html):
            # Nothing to add
            log.debug("No unassigned barcode info in {}".format(config.analysis_dir))
            raise UserWarning
